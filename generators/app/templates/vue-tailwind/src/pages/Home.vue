        ...
        <div class="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
            ...
            <div class="flex flex-col w-full lg:w-1/2 justify-center items-start pt-12 pb-24 px-6">
                ...
                <p class="leading-normal mb-4">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eveniet et perferendis quos. Fuga accusantium, iusto vero odit in itaque nostrum asperiores tempore dolorem similique nam voluptatum saepe magni eius repellendus!
                </p>
            </div>
            <!--Right Col-->
